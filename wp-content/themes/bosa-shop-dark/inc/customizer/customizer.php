 ...
 */
add_action( 'customize_preview_init', 'bosa_shop_dark_customize_preview_js', 999, 1 );

function bosa_shop_dark_customize_preview_js() {
	wp_enqueue_script( 'bosa-shop-dark-customizer', get_stylesheet_directory_uri() . '/inc/customizer/customizer.js', array( 'customize-preview' ) );
}

function bosa_shop_dark_customize_getting_js() {
	wp_dequeue_script( 'bosa-customizer-getting-started' );
	wp_enqueue_script( 'bosa-shop-dark-customizer-getting-started', get_stylesheet_directory_uri() . '/inc/getting-started/getting-started.js', array( 'customize-controls', 'jquery' ), true );

	wp_enqueue_style( 'bosa-shop-dark-customize-controls', get_stylesheet_directory_uri() . '/inc/customizer/customizer.css' );
}
add_action( 'customize_controls_enqueue_scripts', 'bosa_shop_dark_customize_getting_js', 99 );
 ...
 * @return void
 */
add_action( 'init' , 'bosa_shop_dark_kirki_fields', 999, 1 );

function bosa_shop_dark_kirki_fields(){
	...
	*/
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Site Title', 'bosa-shop-dark' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Site Description', 'bosa-shop-dark' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Category Menu', 'bosa-shop-dark' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Main Menu', 'bosa-shop-dark' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Main Menu Description', 'bosa-shop-dark' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Body', 'bosa-shop-dark' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'General Title (H1 - H6)', 'bosa-shop-dark' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Page & Single Post Title', 'bosa-shop-dark' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Title Typography', 'bosa-shop-dark' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Category Typography', 'bosa-shop-dark' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Meta Typography', 'bosa-shop-dark' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Excerpt Typography', 'bosa-shop-dark' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Slider Button Typography', 'bosa-shop-dark' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Content Alignment', 'bosa-shop-dark' ),
		'type'        => 'select',
		'settings'    => 'main_slider_content_alignment',
		'section'     => 'main_slider_options',
		'default'     => 'left',
		'choices'  => array(
			'center' => esc_html__( 'Center', 'bosa-shop-dark' ),
			'left'   => esc_html__( 'Left', 'bosa-shop-dark' ),
			'right'  => esc_html__( 'Right', 'bosa-shop-dark' ),
		),
		'priority'	  =>  180,
		'active_callback' => array(
			array(
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Section Title Typography', 'bosa-shop-dark' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Section Description Typography', 'bosa-shop-dark' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Post Title Typography', 'bosa-shop-dark' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Post Category Typography', 'bosa-shop-dark' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Post Meta Typography', 'bosa-shop-dark' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Post Excerpt Typography', 'bosa-shop-dark' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Widget Title Typography', 'bosa-shop-dark' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Header Layouts', 'bosa-shop-dark' ),
		'description' => esc_html__( 'Select layout & scroll below to change its options', 'bosa-shop-dark' ),
		'type'        => 'radio-image',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Top Header Section', 'bosa-shop-dark' ),
		'type'         => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Advertisement Text Color', 'bosa-shop-dark' ),
		'type'         => 'color',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Advertisement Banner', 'bosa-shop-dark' ),
		'description'  => esc_html__( 'Image dimensions 555 by 68 pixels is recommended.', 'bosa-shop-dark' ),
		'type'         => 'image',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Choose Image Size', 'bosa-shop-dark' ),
		'type'        => 'select',
		'settings'    => 'render_header_ad_image_size',
		'section'     => 'header_style_options',
		'default'     => 'full',
		'placeholder' => esc_html__( 'Select Image Size', 'bosa-shop-dark' ),
	...
	Kirki::add_field( 'bosa', array(
		'label'    => esc_html__( 'Advertisement Banner Link', 'bosa-shop-dark' ),
		'type'     => 'link',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Non Transparent Mid Header Background Color', 'bosa-shop-dark' ),
		'description'  => esc_html__( 'It can be used as a transparent background color over image.', 'bosa-shop-dark' ),
		'type'         => 'color',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Non Transparent Mid Header Text Color', 'bosa-shop-dark' ),
		'type'         => 'color',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Cart Count Background Color', 'bosa-shop-dark' ),
		'type'         => 'color',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Cart Count Color', 'bosa-shop-dark' ),
		'type'         => 'color',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Non Transparent Mid Header Text Link Hover Color', 'bosa-shop-dark' ),
		'type'         => 'color',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Mid Header Section Border', 'bosa-shop-dark' ),
		'type'         => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Category Menu', 'bosa-shop-dark' ),
		'type'         => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Category Menu Background Color', 'bosa-shop-dark' ),
		'type'         => 'color',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Category Menu Text Color', 'bosa-shop-dark' ),
		'type'         => 'color',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Header Height (in px)', 'bosa-shop-dark' ),
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Advertisement Text', 'bosa-shop-dark' ),
		'type'         => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'    => esc_html__( 'Advertisement Text', 'bosa-shop-dark' ),
		'type'     => 'text',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Contact Details', 'bosa-shop-dark' ),
		'type'         => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Phone Number', 'bosa-shop-dark' ),
		'type'         => 'text',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable WooCommerce Compare', 'bosa-shop-dark' ),
		'type'         => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'    => esc_html__( 'Disable WooCommerce Wishlist', 'bosa-shop-dark' ),
		'type'     => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'    => esc_html__( 'Disable WooCommerce My Account', 'bosa-shop-dark' ),
		'type'     => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'    => esc_html__( 'Disable WooCommerce Cart', 'bosa-shop-dark' ),
		'type'     => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Disable Header Advertisement Banner', 'bosa-shop-dark' ),
		'type'        => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Disable Header Secondary Menu', 'bosa-shop-dark' ),
		'type'        => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Footer Layouts', 'bosa-shop-dark' ),
		'type'        => 'radio-image',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Bottom Footer Typography', 'bosa-shop-dark' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Select Image', 'bosa-shop-dark' ),
		'type'         => 'image',
	...
	Kirki::add_field( 'bosa', array(
		'label'    => esc_html__( 'Image Link', 'bosa-shop-dark' ),
		'type'     => 'link',
	...
	Kirki::add_field( 'bosa', array(
		'label'    => esc_html__( 'Image Target', 'bosa-shop-dark' ),
		'description' => esc_html__( 'If enabled, the page will be open in an another browser tab.', 'bosa-shop-dark' ),
		'type'     => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Image Width', 'bosa-shop-dark' ),
		'type'         => 'slider',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Section Border', 'bosa-shop-dark' ),
		'type'         => 'checkbox',
	...
	Kirki::add_section( 'feature_posts_options', array(
	    'title'          => esc_html__( 'Featured Posts / Pages', 'bosa-shop-dark' ),
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Featured Posts / Pages', 'bosa-shop-dark' ),
		...
		'priority'    => '9',
		'choices'  => array(
			'featured_posts' => esc_html__( 'Featured Posts', 'bosa-shop-dark' ),
			'featured_pages' => esc_html__( 'Featured Pages', 'bosa-shop-dark' ),
		)
	) );

	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Featured Posts Section', 'bosa-shop-dark' ),
		'type'         => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Section Title', 'bosa-shop-dark' ),
		'type'         => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Section Title', 'bosa-shop-dark' ),
		'type'        => 'text',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Section Description', 'bosa-shop-dark' ),
		'type'         => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Section Description', 'bosa-shop-dark' ),
		'type'        => 'text',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Section Title and Description Alignment', 'bosa-shop-dark' ),
		'type'        => 'select',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Section Layout', 'bosa-shop-dark' ),
		'description' => esc_html__( 'Select layout & scroll below to change its options', 'bosa-shop-dark' ),
		'type'        => 'radio-image',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Post Title Color', 'bosa-shop-dark' ),
		'type'         => 'color',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Post Category Background Color', 'bosa-shop-dark' ),
		'type'         => 'color',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Post Category Color', 'bosa-shop-dark' ),
		'type'         => 'color',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Post Meta Text Color', 'bosa-shop-dark' ),
		'type'         => 'color',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Post Meta Icon Color', 'bosa-shop-dark' ),
		'type'         => 'color',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Post Hover Color', 'bosa-shop-dark' ),
		'type'         => 'color',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Columns', 'bosa-shop-dark' ),
		'type'        => 'select',
		'settings'    => 'feature_posts_columns',
		'section'     => 'feature_posts_options',
		'default'     => 'three_columns',
		'placeholder' => esc_attr__( 'Select category', 'bosa-shop-dark' ),
		'choices'  => array(
			'one_column'    => esc_html__( '1 Column', 'bosa-shop-dark' ),
			'two_columns'   => esc_html__( '2 Columns', 'bosa-shop-dark' ),
			'three_columns' => esc_html__( '3 Columns', 'bosa-shop-dark' ),
			'four_columns'  => esc_html__( '4 Columns', 'bosa-shop-dark' ),
		),
		'priority'	  =>  160,
		'active_callback' => array(
			array(
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Choose Category', 'bosa-shop-dark' ),
		'description' => esc_html__( 'Recent posts will show if any category is not chosen.', 'bosa-shop-dark' ),
		'type'        => 'select',
		'settings'    => 'feature_posts_category',
		'section'     => 'feature_posts_options',
		'default'     => '',
		'placeholder' => esc_html__( 'Select category', 'bosa-shop-dark' ), 
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Featured Posts Overlay Opacity', 'bosa-shop-dark' ),
		'type'        => 'number',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Post View Number', 'bosa-shop-dark' ),
		'description'  => esc_html__( 'Number of posts to show.', 'bosa-shop-dark' ),
		'type'         => 'number',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Height (in px)', 'bosa-shop-dark' ),
		'description'  => esc_html__( 'This option will only apply to Desktop. Please click on below Desktop Icon to see changes. Automatically adjust by theme default in the responsive devices.
		', 'bosa-shop-dark' ),
		'type'         => 'slider',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Background Image Size', 'bosa-shop-dark' ),
		'type'         => 'radio',
		'settings'     => 'feature_posts_image_size',
		'section'      => 'feature_posts_options',
		'default'      => 'cover',
		'choices'      => array(
			'cover'    => esc_html__( 'Cover', 'bosa-shop-dark' ),
			'pattern'  => esc_html__( 'Pattern / Repeat', 'bosa-shop-dark' ),
			'norepeat' => esc_html__( 'No Repeat', 'bosa-shop-dark' ),
		),
		'priority'	   =>  220,
		'active_callback' => array(
			array(
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Posts Border Radius (px)', 'bosa-shop-dark' ),
		'type'        => 'slider',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Post Text Alignment', 'bosa-shop-dark' ),
		'type'        => 'select',
		'settings'    => 'feature_posts_text_alignment',
		'section'     => 'feature_posts_options',
		'default'     => 'text-left',
		'choices'     => array(
			'text-left'	 	=> esc_html__( 'Left', 'bosa-shop-dark' ),
			'text-center'  	=> esc_html__( 'Center', 'bosa-shop-dark' ),   
			'text-right'	=> esc_html__( 'Right', 'bosa-shop-dark' ),
		),
		'priority'	  =>  240,
		'active_callback' => array(
			array(
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Post Content Alignment', 'bosa-shop-dark' ),
		'type'        => 'select',
		'settings'    => 'feature_posts_title_alignment',
		'section'     => 'feature_posts_options',
		'default'     => 'align-bottom',
		'choices'     => array(
			'align-top'	 	=> esc_html__( 'Top', 'bosa-shop-dark' ),
			'align-center'  => esc_html__( 'Center', 'bosa-shop-dark' ),   
			'align-bottom'  => esc_html__( 'Bottom', 'bosa-shop-dark' ),
		),
		'priority'	  =>  250,
		'active_callback' => array(
			array(
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Disable Post Title', 'bosa-shop-dark' ),
		'type'        => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Disable Post Title Divider', 'bosa-shop-dark' ),
		'type'        => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Disable Posts category', 'bosa-shop-dark' ),
		'type'        => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Disable Post Date', 'bosa-shop-dark' ),
		'type'        => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Disable Post Author', 'bosa-shop-dark' ),
		'type'        => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Disable Post Comment', 'bosa-shop-dark' ),
		'type'        => 'checkbox',
	...
	// featured pages
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Featured Pages Section', 'bosa-shop-dark' ),
		'type'         => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Page 1', 'bosa-shop-dark' ),
		'type'        => 'select',
		'settings'    => 'featured_pages_one',
		'section'     => 'feature_posts_options',
		'default'     => '',
		'placeholder' => esc_html__( 'Select Page 1', 'bosa-shop-dark' ),
		'choices'     => bosa_shop_dark_get_pages(),
		'priority'	  => 450,
		'active_callback' => array(
			array(
				'setting'  => 'feature_posts_pages_tab',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Page 2', 'bosa-shop-dark' ),
		'type'        => 'select',
		'settings'    => 'featured_pages_two',
		'section'     => 'feature_posts_options',
		'default'     => '',
		'placeholder' => esc_html__( 'Select Page 2', 'bosa-shop-dark' ),
		'choices'     => bosa_shop_dark_get_pages(),
		'priority'	  => 460,
		'active_callback' => array(
			array(
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Page 3', 'bosa-shop-dark' ),
		'type'        => 'select',
		'settings'    => 'featured_pages_three',
		'section'     => 'feature_posts_options',
		'default'     => '',
		'choices'     => bosa_shop_dark_get_pages(),
		'placeholder' => esc_html__( 'Select Page 3', 'bosa-shop-dark' ),
		'priority'	  => 470,
		'active_callback' => array(
			array(
				'setting'  => 'feature_posts_pages_tab',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Page 4', 'bosa-shop-dark' ),
		'type'        => 'select',
		'settings'    => 'featured_pages_four',
		'section'     => 'feature_posts_options',
		'default'     => '',
		'choices'     => bosa_shop_dark_get_pages(),
		'placeholder' => esc_html__( 'Select Page 4', 'bosa-shop-dark' ),
		'priority'	  => 480,
		'active_callback' => array(
			array(
				'setting'  => 'feature_posts_pages_tab',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Featured Page Overlay Opacity', 'bosa-shop-dark' ),
		'type'        => 'number',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Page Border Radius (px)', 'bosa-shop-dark' ),
		'type'        => 'slider',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Disable Page Title', 'bosa-shop-dark' ),
		'type'        => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Page Title Color', 'bosa-shop-dark' ),
		'type'         => 'color',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Page Hover Color', 'bosa-shop-dark' ),
		'type'         => 'color',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Page Title Horizontal Alignment', 'bosa-shop-dark' ),
		'type'        => 'select',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Page Title Vertical Alignment', 'bosa-shop-dark' ),
		'type'        => 'select',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Page Title Typography', 'bosa-shop-dark' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Featured Posts / Pages', 'bosa-shop-dark' ),
		'type'         => 'checkbox',
	...
	Kirki::add_section( 'blog_advert_banner_options', array(
	    'title'          => esc_html__( 'Blog Advertisement Banner', 'bosa-shop-dark' ),
	    'panel'          => 'blog_homepage_options',
	    'capability'     => 'edit_theme_options',
	    'priority'       => '22',
	) );
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Advertisement Banner', 'bosa-shop-dark' ),
		'description'  => esc_html__( 'Image dimensions 1230 by 100 pixels is recommended.', 'bosa-shop-dark' ),
		'type'         => 'image',
	...
	Kirki::add_field( 'bosa', array(
		'label'    		=> esc_html__( 'Advertisement Banner Target', 'bosa-shop-dark' ),
		'description' 	=> esc_html__( 'If enabled, the page will be open in an another browser tab.', 'bosa-shop-dark' ),
		'type'     		=> 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Advertisement Banner', 'bosa-shop-dark' ),
		'type'         => 'checkbox',
	...
	Kirki::add_section( 'blog_featured_categories', array(
	    'title'          => esc_html__( 'Featured Categories', 'bosa-shop-dark' ),
	    'panel'          => 'blog_homepage_options',
	    'capability'     => 'edit_theme_options',
	    'priority'       => 24,
	) );
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Featured Categories Section', 'bosa-shop-dark' ),
		'type'         => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Category One', 'bosa-shop-dark' ),
		'type'        => 'select',
		'settings'    => 'featured_category_one',
		'section'     => 'blog_featured_categories',
		'default'     => '',
		'placeholder' => esc_html__( 'Select Category One', 'bosa-shop-dark' ),
		'choices'     => bosa_get_post_categories(),
		'priority'	  => 20,
	));

	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Category One Image', 'bosa-shop-dark' ),
		'type'         => 'image',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Category Two', 'bosa-shop-dark' ),
		'type'        => 'select',
		'settings'    => 'featured_category_two',
		'section'     => 'blog_featured_categories',
		'default'     => '',
		'placeholder' => esc_html__( 'Select Category Two', 'bosa-shop-dark' ),
		'choices'     => bosa_get_post_categories(),
		'priority'	  => 40,
	));

	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Category Two Image', 'bosa-shop-dark' ),
		'type'         => 'image',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Category Three', 'bosa-shop-dark' ),
		'type'        => 'select',
		'settings'    => 'featured_category_three',
		'section'     => 'blog_featured_categories',
		'default'     => '',
		'placeholder' => esc_html__( 'Select Category Three', 'bosa-shop-dark' ),
		'choices'     => bosa_get_post_categories(),
		'priority'	  => 60,
	));

	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Category Three Image', 'bosa-shop-dark' ),
		'type'         => 'image',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Category Four', 'bosa-shop-dark' ),
		'type'        => 'select',
		'settings'    => 'featured_category_four',
		'section'     => 'blog_featured_categories',
		'default'     => '',
		'placeholder' => esc_html__( 'Select Category Four', 'bosa-shop-dark' ),
		'choices'     => bosa_get_post_categories(),
		'priority'	  => 80,
	));

	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Category Four Image', 'bosa-shop-dark' ),
		'type'         => 'image',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Category Five', 'bosa-shop-dark' ),
		'type'        => 'select',
		'settings'    => 'featured_category_five',
		'section'     => 'blog_featured_categories',
		'default'     => '',
		'placeholder' => esc_html__( 'Select Category Five', 'bosa-shop-dark' ),
		'choices'     => bosa_get_post_categories(),
		'priority'	  => 100,
	));

	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Category Five Image', 'bosa-shop-dark' ),
		'type'         => 'image',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Featured Categories', 'bosa-shop-dark' ),
		'type'         => 'checkbox',
	...
	Kirki::add_section( 'feature_posts_two_options', array(
	    'title'          => esc_html__( 'Featured Posts Two', 'bosa-shop-dark' ),
	    'panel'          => 'blog_homepage_options',
	    'capability'     => 'edit_theme_options',
	    'priority'       => 25,
	) );
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Featured Posts Two Section', 'bosa-shop-dark' ),
		'type'         => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Posts Overlay Opacity', 'bosa-shop-dark' ),
		'type'        => 'number',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Post Content Horizontal Alignment', 'bosa-shop-dark' ),
		'type'        => 'select',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Post Content Vertical Alignment', 'bosa-shop-dark' ),
		'type'        => 'select',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Featured Posts Two', 'bosa-shop-dark' ),
		'type'         => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Post Layouts', 'bosa-shop-dark' ),
		'description' => esc_html__( 'Grid / List / Single/ Grid Thumbnail', 'bosa-shop-dark' ),
		'type'        => 'radio-image',
	...
	Kirki::add_field( 'bosa', array(
	    ...
	    'section'     => 'blog_page_style_options',
	    'default'     => esc_html__( 'Thumbnail Post Options', 'bosa-shop-dark' ),
	    'priority'	  => 300,
	    'active_callback' => array(
			array(
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Choose Image Size', 'bosa-shop-dark' ),
		'description' => esc_html__( 'Image Size for thumbnail post only.', 'bosa-shop-dark' ),
		'type'        => 'select',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Post Border Radius (px)', 'bosa-shop-dark' ),
		'description' => esc_html__( 'Post Border Radius for thumbnail post only.', 'bosa-shop-dark' ),
		'type'        => 'slider',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Date', 'bosa-shop-dark' ),
		'description'  => esc_html__( 'Disables date for thumbnail post only.', 'bosa-shop-dark' ),
		'type'         => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Author', 'bosa-shop-dark' ),
		'description'  => esc_html__( 'Disables author for thumbnail post only.', 'bosa-shop-dark' ),
		'type'         => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Comment Link', 'bosa-shop-dark' ),
		'description'  => esc_html__( 'Disables comment link for thumbnail post only.', 'bosa-shop-dark' ),
		'type'         => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Excerpt', 'bosa-shop-dark' ),
		'description'  => esc_html__( 'Disables excerpt for thumbnail post only.', 'bosa-shop-dark' ),
		'type'         => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Post Button', 'bosa-shop-dark' ),
		'description'  => esc_html__( 'Disables button for thumbnail post only.', 'bosa-shop-dark' ),
		'type'         => 'checkbox',
	...
	Kirki::add_section( 'blog_services', array(
	    'title'          => esc_html__( 'Services', 'bosa-shop-dark' ),
	    'panel'          => 'blog_homepage_options',
	    'capability'     => 'edit_theme_options',
	    'priority'       => 26,
	) );
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Services Section', 'bosa-shop-dark' ),
		'type'         => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Services', 'bosa-shop-dark' ),
		'type'         => 'checkbox',
	...
	//Vouchers
	Kirki::add_section( 'blog_vouchers', array(
	    'title'          => esc_html__( 'Vouchers', 'bosa-shop-dark' ),
	    'panel'          => 'blog_homepage_options',
	    'capability'     => 'edit_theme_options',
	    'priority'       => 27,
	) );
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Vouchers Section', 'bosa-shop-dark' ),
		'type'         => 'checkbox',
		'settings'     => 'disable_vouchers_section',
		'section'      => 'blog_vouchers',
		'default'      => true,
		'priority'	   => 10,
	) );

	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Voucher One', 'bosa-shop-dark' ),
		'type'         => 'image',
		'settings'     => 'blog_voucher_one',
		'section'      => 'blog_vouchers',
		'default'      => '',
		'priority'	   => 20,
		'choices'     => array(
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Voucher two', 'bosa-shop-dark' ),
		'type'         => 'image',
		'settings'     => 'blog_voucher_two',
		'section'      => 'blog_vouchers',
		'default'      => '',
		'priority'	   => 30,
		'choices'     => array(
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Voucher Three', 'bosa-shop-dark' ),
		'type'         => 'image',
		'settings'     => 'blog_voucher_three',
		'section'      => 'blog_vouchers',
		'default'      => '',
		'priority'	   => 40,
		'choices'     => array(
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Voucher Four', 'bosa-shop-dark' ),
		'type'         => 'image',
		'settings'     => 'blog_voucher_four',
		'section'      => 'blog_vouchers',
		'default'      => '',
		'priority'	   => 50,
		'choices'     => array(
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Vouchers', 'bosa-shop-dark' ),
		'type'         => 'checkbox',
		'settings'     => 'disable_mobile_vouchers',
		'section'      => 'blog_page_responsive',
		'default'      => false,
		'priority'	   => 27,
		'active_callback' => array(
			array(
				'setting'  => 'disable_vouchers_section',
				'operator' => '==',
				'value'    => false,
			),
		),
	...
	//Info 
	Kirki::add_section( 'blog_info', array(
	    'title'          => esc_html__( 'Info', 'bosa-shop-dark' ),
	    'panel'          => 'blog_homepage_options',
	    'capability'     => 'edit_theme_options',
	    'priority'       => 28,
	) );
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Info Section', 'bosa-shop-dark' ),
		'type'         => 'checkbox',
		'settings'     => 'disable_info_section',
		'section'      => 'blog_info',
		'default'      => true,
		'priority'	   => 10,
	) );
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Info one', 'bosa-shop-dark' ),
		'type'        => 'text',
		'settings'    => 'info_one_title',
		'section'     => 'blog_info',
		'default'     => '',
		'priority'	   => 20,
	) );
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Content One', 'bosa-shop-dark' ),
		'type'        => 'text',
		'settings'    => 'info_one_content_one',
		'section'     => 'blog_info',
		'default'     => '',
		'priority'	   => 30,
	) );
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Content Two', 'bosa-shop-dark' ),
		'type'        => 'text',
		'settings'    => 'info_one_content_two',
		'section'     => 'blog_info',
		'default'     => '',
		'priority'	   => 40,
	) );
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Info Two', 'bosa-shop-dark' ),
		'type'        => 'text',
		'settings'    => 'info_two_title',
		'section'     => 'blog_info',
		'default'     => '',
		'priority'	   => 50,
	) );
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Info Three', 'bosa-shop-dark' ),
		'type'        => 'text',
		'settings'    => 'info_three_title',
		'section'     => 'blog_info',
		'default'     => '',
		'priority'	   => 80,
	) );
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Content One', 'bosa-shop-dark' ),
		'type'        => 'text',
		'settings'    => 'info_three_content_one',
		'section'     => 'blog_info',
		'default'     => '',
		'priority'	   => 90,
	) );
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Content Two', 'bosa-shop-dark' ),
		'type'        => 'text',
		'settings'    => 'info_three_content_two',
		'section'     => 'blog_info',
		'default'     => '',
		'priority'	   => 100,
	) );
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Info', 'bosa-shop-dark' ),
		'type'         => 'checkbox',
		'settings'     => 'disable_mobile_info',
		'section'      => 'blog_page_responsive',
		'default'      => false,
		'priority'	   => 28,
		'active_callback' => array(
			array(
				'setting'  => 'disable_info_section',
				'operator' => '==',
				'value'    => false,
			),
		),
	...
	Kirki::add_section( 'blog_reviews', array(
	    'title'          => esc_html__( 'Reviews', 'bosa-shop-dark' ),
	    'panel'          => 'blog_homepage_options',
	    'capability'     => 'edit_theme_options',
	    'priority'       => 29,
	) );
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Reviews Section', 'bosa-shop-dark' ),
		'type'         => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Reviews', 'bosa-shop-dark' ),
		'type'         => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Product Title Typography', 'bosa-shop-dark' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Product Price Typography', 'bosa-shop-dark' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Add to Cart Button Typography', 'bosa-shop-dark' ),
		'type'         => 'typography',
