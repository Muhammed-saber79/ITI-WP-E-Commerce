...
function bosa_shop_dark_default_styles(){
	...
	# Responsive Info
	if( get_theme_mod( 'disable_mobile_info', false ) ){
		$css .= '
			@media screen and (max-width: 767px){
				.section-info-area {
	    			display: none;
	...
	if( get_theme_mod( 'skin_select', 'default' ) == 'dark' ){
		$css .= '
			...
			.header-four #offcanvas-menu .header-search-form {
...
add_action( 'wp_head', 'bosa_shop_dark_default_styles', 99 );