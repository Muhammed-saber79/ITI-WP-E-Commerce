...
?>
	...
	<div id="content" class="site-content">
		<div class="container">
			...
			<?php bosa_shop_dark_blog_advertisement_banner(); ?>
			...
			<!--Blog Vouchers-->
			<?php get_template_part( 'template-parts/vouchers/vouchers' ); ?>
							...
							<?php
								if( !get_theme_mod( 'disable_pagination', false ) ):
									the_posts_pagination( array(
										...
										'next_text' => '<span>'.esc_html__( 'Next', 'bosa-shop-dark' ) .'</span><span class="screen-reader-text">' . esc_html__( 'Next page', 'bosa-shop-dark' ) . '</span>',
										'prev_text' => '<span>'.esc_html__( 'Prev', 'bosa-shop-dark' ) .'</span><span class="screen-reader-text">' . esc_html__( 'Previous page', 'bosa-shop-dark' ) . '</span>',
										'before_page_number' => '<span class="meta-nav screen-reader-text">' . esc_html__( 'Page', 'bosa-shop-dark' ) . ' </span>',
									));
								endif;
								wp_reset_postdata();
							?>
